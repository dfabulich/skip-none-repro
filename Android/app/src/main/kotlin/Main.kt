...
internal val logger: SkipLogger = SkipLogger(subsystem = "skip.none.repro", category = "SkipNoneRepro")
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        SkipNoneReproAppDelegate.shared.onStart()
    }

    override fun onResume() {
        super.onResume()
        SkipNoneReproAppDelegate.shared.onResume()
    }

    override fun onPause() {
        super.onPause()
        SkipNoneReproAppDelegate.shared.onPause()
    }

    override fun onStop() {
        super.onStop()
        SkipNoneReproAppDelegate.shared.onStop()
    }

    override fun onDestroy() {
        super.onDestroy()
        SkipNoneReproAppDelegate.shared.onDestroy()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        SkipNoneReproAppDelegate.shared.onLowMemory()
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            SkipNoneReproRootView().Compose(context = contentContext)
        }
    }
}
